    ...
    <>
      ...
      <div className="widgetbox">
        <div className="left">
          ...
          <div sx={{ width: '100%' }}>
            <LinearDeterminate
              value={(prBar.got / (prBar.total === 0 ? 1 : prBar.total)) * 100}
            />
          </div>
        </div>
        <div className="right">
          <div className="percentage positive">
            <h1>
              {(prBar.got / (prBar.total === 0 ? 1 : prBar.total)) * 100}%
              Completed
            </h1>
          </div>
          {/* {data.icon} */}
        ...
        <div className="left">
          ...
          <div sx={{ width: '100%' }}>
            <LinearDeterminate
              value={
                (appraisalBar.got /
                  (appraisalBar.total === 0 ? 1 : appraisalBar.total)) *
                100
              }
            />
          </div>
        ...
        <div className="left">
          ...
          <div sx={{ width: '100%' }}>
            <LinearDeterminate
              value={
                (selfAppraised.got /
                  (selfAppraised.total === 0 ? 1 : selfAppraised.total)) *
                100
              }
            />
          </div>
